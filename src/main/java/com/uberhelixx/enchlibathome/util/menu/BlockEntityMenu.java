...
import com.uberhelixx.enchlibathome.util.menu.MenuUtil.PosFactory;
import com.uberhelixx.enchlibathome.util.menu.SimpleDataSlots.IDataAutoRegister;
 ...
 */
public abstract class BlockEntityMenu<T extends BlockEntity> extends BaseMenu {
