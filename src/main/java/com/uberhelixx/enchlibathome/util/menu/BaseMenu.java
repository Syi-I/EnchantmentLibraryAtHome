...
import com.uberhelixx.enchlibathome.util.menu.InternalItemHandler;
import com.uberhelixx.enchlibathome.util.menu.QuickMoveHandler.IExposedContainer;
...
public abstract class BaseMenu extends AbstractContainerMenu implements IExposedContainer {
    ...
    protected BaseMenu(MenuType<?> type, int id, Inventory pInv) {
        super(type, id);
    ...
    protected class UpdatingSlot extends FilteredSlot {
        ...
        public void setChanged() {
            super.setChanged();
            BaseMenu.this.slotsChanged(null);
        }
    }
